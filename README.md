...
- ☝️ *[🐊**Putout** returns object with `code` and `places` properties](https://github.com/erboladaiorg/porro-reiciendis#plugins).*
...
If you want to apply 🐊**Putout** transformations using [`putout/putout`](https://github.com/erboladaiorg/porro-reiciendis/tree/master/packages/eslint-plugin-putout#readme) **ESLint** rule, enable 🐊**Putout** with the same called flag lowercased:
...
🐊**Putout** can have one of next [exit codes](https://github.com/erboladaiorg/porro-reiciendis/blob/master/packages/putout/lib/cli/exit-codes.mjs):
...
If you wish to play with code 🔥, [you can](https://github.com/erboladaiorg/porro-reiciendis/blob/master/CONTRIBUTING.md) 💪!
